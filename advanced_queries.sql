...
-- SELECT * FROM books JOIN authors ON books.publication_date > '1930' WHERE authors.nationality = 'Argentina';
...
SELECT * FROM books JOIN authors ON books.author_id = authors.id WHERE books.publication_date < '1980' AND NOT authors.nationality = 'United States of America';
